...
export interface UnderwriterProxyAdminStorageInterface extends utils.Interface {
  functions: {
...
export interface UnderwriterProxyAdminStorage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UnderwriterProxyAdminStorageInterface;
