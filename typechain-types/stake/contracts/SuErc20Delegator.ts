...
export interface SuErc20DelegatorInterface extends utils.Interface {
  functions: {
...
export interface SuErc20Delegator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SuErc20DelegatorInterface;
