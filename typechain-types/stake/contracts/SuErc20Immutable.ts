...
export interface SuErc20ImmutableInterface extends utils.Interface {
  functions: {
...
export interface SuErc20Immutable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SuErc20ImmutableInterface;
