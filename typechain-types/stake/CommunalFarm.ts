...
export interface CommunalFarmInterface extends utils.Interface {
  functions: {
    ...
    "getAllRewardRates()": FunctionFragment;
...
export type LockedStakeMaxMultiplierUpdatedEvent = TypedEvent<
  [BigNumber],
  LockedStakeMaxMultiplierUpdatedEventObject
>;

export type LockedStakeMaxMultiplierUpdatedEventFilter =
  TypedEventFilter<LockedStakeMaxMultiplierUpdatedEvent>;
...
export type LockedStakeMinTimeEvent = TypedEvent<
  [BigNumber],
  LockedStakeMinTimeEventObject
>;

export type LockedStakeMinTimeEventFilter =
  TypedEventFilter<LockedStakeMinTimeEvent>;
...
export type LockedStakeTimeForMaxMultiplierEvent = TypedEvent<
  [BigNumber],
  LockedStakeTimeForMaxMultiplierEventObject
>;

export type LockedStakeTimeForMaxMultiplierEventFilter =
  TypedEventFilter<LockedStakeTimeForMaxMultiplierEvent>;
...
export interface CommunalFarm extends BaseContract {
  ...
  functions: {
    ...
    getAllRewardRates(overrides?: CallOverrides): Promise<[BigNumber[]]>;
  ...
  filters: {
    "LockedStakeMaxMultiplierUpdated(uint256)"(
      multiplier?: null
    ): LockedStakeMaxMultiplierUpdatedEventFilter;
    ...
    "LockedStakeTimeForMaxMultiplier(uint256)"(
      secs?: null
    ): LockedStakeTimeForMaxMultiplierEventFilter;
  ...
  populateTransaction: {
    ...
    getAllRewardRates(overrides?: CallOverrides): Promise<PopulatedTransaction>;
