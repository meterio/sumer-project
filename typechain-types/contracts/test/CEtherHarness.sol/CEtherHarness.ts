...
export interface CEtherHarnessInterface extends utils.Interface {
  functions: {
...
export interface CEtherHarness extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CEtherHarnessInterface;
  ...
  functions: {
    ...
    harnessRepayBorrowFresh(
      payer: string,
      account: string,
      repayBorrowAmount: BigNumberish,
      overrides?: PayableOverrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
