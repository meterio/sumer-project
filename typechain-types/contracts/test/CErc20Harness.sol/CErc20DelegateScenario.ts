...
export interface CErc20DelegateScenarioInterface extends utils.Interface {
  functions: {
...
export interface CErc20DelegateScenario extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CErc20DelegateScenarioInterface;
