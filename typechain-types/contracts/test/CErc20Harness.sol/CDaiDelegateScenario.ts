...
export interface CDaiDelegateScenarioInterface extends utils.Interface {
  functions: {
...
export interface CDaiDelegateScenario extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CDaiDelegateScenarioInterface;
