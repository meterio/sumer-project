...
export interface CErc20DelegatorScenarioInterface extends utils.Interface {
  functions: {
...
export interface CErc20DelegatorScenario extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CErc20DelegatorScenarioInterface;
