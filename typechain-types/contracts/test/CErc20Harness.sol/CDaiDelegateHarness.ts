...
export interface CDaiDelegateHarnessInterface extends utils.Interface {
  functions: {
...
export interface CDaiDelegateHarness extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CDaiDelegateHarnessInterface;
