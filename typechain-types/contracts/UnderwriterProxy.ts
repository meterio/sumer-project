...
export interface UnderwriterProxyInterface extends utils.Interface {
  functions: {
...
export interface UnderwriterProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UnderwriterProxyInterface;
