...
export interface SuErc20DelegateInterface extends utils.Interface {
  functions: {
...
export interface SuErc20Delegate extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SuErc20DelegateInterface;
