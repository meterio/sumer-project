...
// File contracts/suErc20Delegator.sol
 ...
 * @author Compound
 */
contract suErc20Delegator is CTokenInterface, CErc20Interface, CDelegatorInterface {
  /**
  ...
  function _setImplementation(
    ...
    require(implementation_ != address(0), 'Address is Zero!');
