...
require("./tasks");
const deployTool_1 = require("./scripts/deployTool");
...
exports.default = {
    ...
    networks: {
        hardhat: {
            ...
            timeout: 99999 * 2,
            gas: argv.hardhatChainId === 137 ? 19000000 :
                argv.hardhatChainId === 80001 ? 19000000 :
                    undefined,
            forking: !!argv.hardhatChainId && argv.hardhatChainId !== 31337 ? {
                url: argv.hardhatChainId === 137 ? argv.maticRpcUrl :
                    argv.hardhatChainId === 250 ? argv.ftmRpcUrl :
                        argv.hardhatChainId === 80001 ? argv.mumbaiRpcUrl :
                            undefined,
                blockNumber: argv.hardhatChainId === 137 ? argv.maticForkBlock !== 0 ? argv.maticForkBlock : undefined :
    ...
    solidity: {
        compilers: [(0, deployTool_1.compileSetting)('0.6.11', 200), (0, deployTool_1.compileSetting)('0.7.6', 200), (0, deployTool_1.compileSetting)('0.8.11', 200)]
    },
    paths: {
        sources: "./contracts",
        tests: "./test",
