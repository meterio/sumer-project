...
import { SuErc20, ERC20MinterBurnerPauser, SumerOFTUpgradeable__factory } from '../../../typechain';
...
task('doft', 'deploy suToken contract')
  ...
  .setAction(async ({ name, symbol, admin, rpc, pk, gasprice }, { ethers, run, network }) => {
