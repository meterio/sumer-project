...
export interface TimeBasedJumpRateModelInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "jumpMultiplierPerTimestamp",
    values?: undefined
  ): string;
...
export namespace NewInterestParamsEvent {
  export type InputTuple = [
    ...
    jumpMultiplierPerTimestamp: BigNumberish,
    kink: BigNumberish
  ];
  export type OutputTuple = [
    baseRatePerTimestamp: bigint,
    multiplierPerTimestamp: bigint,
    jumpMultiplierPerTimestamp: bigint,
    kink: bigint
  ];
...
export interface TimeBasedJumpRateModel extends BaseContract {
  connect(runner?: ContractRunner | null): TimeBasedJumpRateModel;
  waitForDeployment(): Promise<this>;

  interface: TimeBasedJumpRateModelInterface;
  ...
  jumpMultiplierPerTimestamp: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "jumpMultiplierPerTimestamp"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
