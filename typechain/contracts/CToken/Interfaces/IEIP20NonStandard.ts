...
export interface IEIP20NonStandardInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface IEIP20NonStandard extends BaseContract {
  connect(runner?: ContractRunner | null): IEIP20NonStandard;
