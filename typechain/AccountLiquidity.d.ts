...
interface AccountLiquidityInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getIntermediateGroupSummary(address,address,uint256,uint256)": FunctionFragment;
...
export class AccountLiquidity extends BaseContract {
